...
public class CustomerController {
     ...
     public ResponseEntity<Nullable> deleteCustomer(@PathVariable Long custId){
          customerService.removeCustomerBy(custId);
          return ResponseEntity.status(HttpStatus.OK).body(null);
     }

     @PutMapping("{custId}")
     public ResponseEntity<Customer> updateCustomer(@PathVariable("custId") Long id,@RequestBody Customer customer) {
